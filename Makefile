...
pkgdatadir = $(datadir)/main-c
pkgincludedir = $(includedir)/main-c
pkglibdir = $(libdir)/main-c
pkglibexecdir = $(libexecdir)/main-c
...
ACLOCAL = ${SHELL} /home/ubuntu/bbq_new/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/ubuntu/bbq_new/missing autoconf
AUTOHEADER = ${SHELL} /home/ubuntu/bbq_new/missing autoheader
AUTOMAKE = ${SHELL} /home/ubuntu/bbq_new/missing automake-1.15
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/ubuntu/bbq_new/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = main-c
PACKAGE_BUGREPORT = 
PACKAGE_NAME = main.c
PACKAGE_STRING = main.c 1.0
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/ubuntu/bbq_new
abs_srcdir = /home/ubuntu/bbq_new
abs_top_builddir = /home/ubuntu/bbq_new
abs_top_srcdir = /home/ubuntu/bbq_new
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/ubuntu/bbq_new/install-sh
...
LLFLAGS = `pkg-config --libs --cflags gtk+-2.0`
...
bbq$(EXEEXT): $(bbq_OBJECTS) $(bbq_DEPENDENCIES) $(EXTRA_bbq_DEPENDENCIES) 
	@rm -f bbq$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(bbq_OBJECTS) $(bbq_LDADD) $(LIBS)
